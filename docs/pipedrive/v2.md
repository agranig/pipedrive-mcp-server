...
All URIs are relative to *[https://api.pipedrive.com/api/v2](https://api.pipedrive.com/api/v2)*
...
- **Type**: OAuth
- **Flow**: accessCode
- **Authorization URL**: [https://oauth.pipedrive.com/oauth/authorize](https://oauth.pipedrive.com/oauth/authorize)
- **Scopes**: 
